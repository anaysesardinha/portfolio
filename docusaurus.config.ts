...
const config: Config = {
  ...
  url: 'https://anaysesardinha.github.io',
  ...
  organizationName: 'anaysesardinha', // Usually your GitHub org/user name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/anaysesardinha/portfolio/tree/main/',
        },
        blog: {
